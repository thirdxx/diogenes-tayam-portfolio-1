                ...
                {navItems.map((item) => (
                  <div key={item.href}>
                    {location.pathname === "/" ? (
                      <button
                        onClick={() => scrollToSection(item.label.toLowerCase())}
                        className="text-foreground hover:text-primary block px-3 py-2 rounded-md text-base font-medium w-full text-left transition-colors duration-200 hover:bg-accent/10"
                      >
                        {item.label}
                      </button>
                    ) : (
